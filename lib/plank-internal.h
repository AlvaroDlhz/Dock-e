/* plank-internal.h generated by valac 0.56.16, the Vala compiler, do not modify */
...
VALA_EXTERN GQuark plank_quark_surface_stats;
VALA_EXTERN void plank_internal_quarks_initialize (void);
VALA_EXTERN GType plank_matcher_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (PlankMatcher, g_object_unref)
VALA_EXTERN PlankMatcher* plank_matcher_get_default (void);
VALA_EXTERN GeeArrayList* plank_matcher_active_launchers (PlankMatcher* self);
VALA_EXTERN BamfApplication* plank_matcher_app_for_uri (PlankMatcher* self,
                                            const gchar* uri);
VALA_EXTERN void plank_matcher_set_favorites (PlankMatcher* self,
                                  GeeArrayList* favs);
VALA_EXTERN GType plank_struts_get_type (void) G_GNUC_CONST ;
VALA_EXTERN GType plank_window_control_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (PlankWindowControl, g_object_unref)
VALA_EXTERN void plank_window_control_initialize (void);
VALA_EXTERN GdkPixbuf* plank_window_control_get_app_icon (BamfApplication* app);
VALA_EXTERN GdkPixbuf* plank_window_control_get_window_icon (BamfWindow* window);
VALA_EXTERN gboolean plank_window_control_has_maximized_window (BamfApplication* app);
VALA_EXTERN gboolean plank_window_control_has_minimized_window (BamfApplication* app);
VALA_EXTERN gboolean plank_window_control_has_window_on_workspace (BamfApplication* app,
                                                       WnckWorkspace* workspace);
VALA_EXTERN void plank_window_control_update_icon_regions (BamfApplication* app,
                                               GdkRectangle* rect);
VALA_EXTERN void plank_window_control_close_all (BamfApplication* app,
                                     guint32 event_time);
VALA_EXTERN void plank_window_control_focus_window (BamfWindow* window,
                                        guint32 event_time);
VALA_EXTERN void plank_window_control_focus_previous (BamfApplication* app,
                                          guint32 event_time);
VALA_EXTERN void plank_window_control_focus_next (BamfApplication* app,
                                      guint32 event_time);
VALA_EXTERN void plank_window_control_minimize (BamfApplication* app);
VALA_EXTERN void plank_window_control_restore (BamfApplication* app,
                                   guint32 event_time);
VALA_EXTERN void plank_window_control_maximize (BamfApplication* app);
VALA_EXTERN void plank_window_control_unmaximize (BamfApplication* app);
VALA_EXTERN GList* plank_window_control_get_ordered_window_stack (BamfApplication* app);
VALA_EXTERN void plank_window_control_smart_focus (BamfApplication* app,
                                       guint32 event_time);
VALA_EXTERN void plank_window_control_get_easy_geometry (WnckWindow* w,
                                             GdkRectangle* result);
VALA_EXTERN GSettings* plank_create_settings (const gchar* schema_id,
                                  const gchar* path);
VALA_EXTERN GSettings* plank_try_create_settings (const gchar* schema_id,
                                      const gchar* path);
VALA_EXTERN gchar** plank_string_split_combine (const gchar* s,
                                    const gchar* delimiter,
                                    gint* result_length1);
VALA_EXTERN gboolean plank_file_is_dockitem (GFile* file);
VALA_EXTERN gdouble plank_nround (gdouble d,
                      guint n);
VALA_EXTERN GType plank_docklet_view_model_get_type (void) G_GNUC_CONST ;
G_DEFINE_AUTOPTR_CLEANUP_FUNC (PlankDockletViewModel, g_object_unref)
VALA_EXTERN GType plank_docklet_view_model_column_get_type (void) G_GNUC_CONST ;
VALA_EXTERN PlankDockletViewModel* plank_docklet_view_model_new (void);
VALA_EXTERN PlankDockletViewModel* plank_docklet_view_model_construct (GType object_type);
VALA_EXTERN void plank_docklet_view_model_add (PlankDockletViewModel* self,
                                   const gchar* id,
                                   const gchar* name,
