...
static void ___lambda80_ (PlankApplicationDockItem* self);
static void ____lambda80__gtk_menu_item_activate (GtkMenuItem* _sender,
                                           gpointer self);
static void ___lambda81_ (Block7Data* _data7_);
...
static void _____lambda82_ (Block8Data* _data8_);
static void ______lambda82__gtk_menu_item_activate (GtkMenuItem* _sender,
                                             gpointer self);
static Block9Data* block9_data_ref (Block9Data* _data9_);
static void block9_data_unref (void * _userdata_);
static void ______lambda83_ (Block9Data* _data9_);
static void _______lambda83__gtk_menu_item_activate (GtkMenuItem* _sender,
                                              gpointer self);
...
static void
___lambda80_ (PlankApplicationDockItem* self)
{
...
static void
___lambda81_ (Block7Data* _data7_)
{
	PlankApplicationDockItem* self;
	BamfApplication* _tmp0_;
	BamfApplication* _tmp1_;
...
static void
_____lambda82_ (Block8Data* _data8_)
{
	Block7Data* _data7_;
	PlankApplicationDockItem* self;
	GError* _inner_error0_ = NULL;
...
static void
______lambda83_ (Block9Data* _data9_)
{
	Block7Data* _data7_;
	PlankApplicationDockItem* self;
	BamfWindow* _tmp0_;
...
static void
_______lambda83__gtk_menu_item_activate (GtkMenuItem* _sender,
                                         gpointer self)
{
	______lambda83_ (self);
}
...
plank_application_dock_item_real_get_menu_items (PlankDockElement* base)
{
	...
	if (_tmp10_) {
		...
		_tmp20_ = item;
		g_signal_connect_object ((GtkMenuItem*) _tmp20_, "activate", (GCallback) ____lambda80__gtk_menu_item_activate, self, 0);
		_tmp21_ = items;
		_tmp22_ = item;
	...
	if (_tmp23_) {
		...
		item = _tmp25_;
		_tmp26_ = item;
		g_signal_connect_data (_tmp26_, "activate", (GCallback) ____lambda81__gtk_menu_item_activate, block7_data_ref (_data7_), (GClosureNotify) block7_data_unref, 0);
		_tmp27_ = items;
		_tmp28_ = item;
	...
	if (_tmp51_) {
		...
		}
		{
			...
			while (TRUE) {
				...
				item = _tmp79_;
				_tmp80_ = item;
				g_signal_connect_data (_tmp80_, "activate", (GCallback) ______lambda82__gtk_menu_item_activate, block8_data_ref (_data8_), (GClosureNotify) block8_data_unref, 0);
				_tmp81_ = items;
				_tmp82_ = item;
			...
			for (view_it = view_collection; view_it != NULL; view_it = view_it->next) {
				...
				view = (BamfView*) view_it->data;
				{
					...
					if (bamf_view_is_active ((BamfView*) _tmp112_)) {
						...
						g_signal_connect_data (_tmp114_, "activate", (GCallback) _______lambda83__gtk_menu_item_activate, block9_data_ref (_data9_), (GClosureNotify) block9_data_unref, 0);
					}
					_tmp115_ = items;
