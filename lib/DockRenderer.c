...
static gboolean __lambda139_ (PlankDockRenderer* self);
...
static gboolean ___lambda141_ (Block1Data* _data1_);
static gboolean ____lambda141__gsource_func (gpointer self);
static gdouble plank_dock_renderer_easing_bounce (gdouble t,
                                           gdouble d,
                                           gdouble n);
static Block2Data* block2_data_ref (Block2Data* _data2_);
static void block2_data_unref (void * _userdata_);
static gboolean __lambda140_ (Block2Data* _data2_,
                       PlankDockElement* i,
                       PlankDockItemDrawValue* val);
static gboolean ___lambda140__gee_forall_map_func (gconstpointer k,
                                            gconstpointer v,
                                            gpointer self);
...
static gboolean
__lambda139_ (PlankDockRenderer* self)
{
	PlankDockController* _tmp0_;
...
{
	gboolean result;
	result = __lambda139_ ((PlankDockRenderer*) self);
	return result;
}
...
plank_dock_renderer_reset_position_manager (PlankDockRenderer* self)
{
	...
	self->priv->reset_position_manager_timer_id = gdk_threads_add_timeout ((guint) 50, ___lambda139__gsource_func, self);
}
...
static gboolean
___lambda141_ (Block1Data* _data1_)
{
	PlankDockRenderer* self;
...
static gboolean
____lambda141__gsource_func (gpointer self)
{
	gboolean result;
	result = ___lambda141_ (self);
	return result;
}
                               ...
                               gint64 frame_time)
{
	...
	if (self->priv->is_first_frame) {
		...
		gdk_threads_add_idle_full (G_PRIORITY_LOW, ____lambda141__gsource_func, block1_data_ref (_data1_), block1_data_unref);
...
static gboolean
__lambda140_ (Block2Data* _data2_,
              PlankDockElement* i,
              PlankDockItemDrawValue* val)
{
	PlankDockRenderer* self;
...
static gboolean
___lambda140__gee_forall_map_func (gconstpointer k,
                                   gconstpointer v,
                                   gpointer self)
{
	gboolean result;
	result = __lambda140_ (self, (PlankDockElement*) k, (PlankDockItemDrawValue*) v);
	return result;
}
                                              ...
                                              PlankDockRenderer* self)
{
	...
	_tmp13_ = _tmp12_;
	gee_map_iterator_foreach (_tmp13_, ___lambda140__gee_forall_map_func, _data2_);
