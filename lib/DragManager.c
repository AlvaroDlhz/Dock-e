...
static void plank_drag_manager_set_DragItem (PlankDragManager* self,
                                      PlankDockItem* value);
static void __lambda99_ (Block3Data* _data3_);
static void ___lambda99__plank_dock_element_needs_redraw (PlankDockElement* _sender,
                                                   gpointer self);
...
static void plank_drag_manager_set_ExternalDragActive (PlankDragManager* self,
                                                gboolean value);
static gboolean ___lambda101_ (PlankDragManager* self);
static gboolean ____lambda101__gsource_func (gpointer self);
static gboolean ___lambda98_ (PlankDragManager* self);
...
static void
__lambda99_ (Block3Data* _data3_)
{
	PlankDragManager* self;
...
static void
___lambda99__plank_dock_element_needs_redraw (PlankDockElement* _sender,
                                              gpointer self)
{
	__lambda99_ (self);
}
                               ...
                               PlankDragManager* self)
{
	...
	_tmp15_ = g_signal_connect_data ((PlankDockElement*) _tmp14_, "needs-redraw", (GCallback) ___lambda99__plank_dock_element_needs_redraw, block3_data_ref (_data3_), (GClosureNotify) block3_data_unref, 0);
...
static gboolean
___lambda101_ (PlankDragManager* self)
{
	PlankDockController* _tmp0_;
...
static gboolean
____lambda101__gsource_func (gpointer self)
{
	gboolean result;
	result = ___lambda101_ ((PlankDragManager*) self);
	return result;
}
                               ...
                               PlankDragManager* self)
{
	...
	if (_tmp4_) {
		...
		gdk_threads_add_idle (____lambda101__gsource_func, self);
	}
...
static gboolean
___lambda98_ (PlankDragManager* self)
{
	PlankDockItem* item = NULL;
	PlankDockController* _tmp0_;
	PlankDockWindow* _tmp1_;
...
{
	gboolean result;
	result = ___lambda98_ ((PlankDragManager*) self);
	return result;
}
...
plank_drag_manager_hovered_item_changed (PlankDragManager* self)
{
	...
	if (_tmp25_) {
		self->priv->drag_hover_timer_id = gdk_threads_add_timeout ((guint) 1500, ____lambda98__gsource_func, self);
	}
}
