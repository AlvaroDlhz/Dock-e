...
static gpointer ___lambda161_ (Block23Data* _data23_);
static gpointer ____lambda161__gthread_func (gpointer self);
static GObject * plank_worker_constructor (GType type,
                                    guint n_construct_properties,
                                    GObjectConstructParam * construct_properties);
static void _plank_worker____lambda162_ (PlankWorker* self,
                                  PlankTask* task);
static void __plank_worker____lambda162__gfunc (gpointer data,
                                         gpointer self);
...
static gpointer
___lambda161_ (Block23Data* _data23_)
{
	PlankWorker* self;
	GType g_type;
	GBoxedCopyFunc g_dup_func;
...
static gpointer
____lambda161__gthread_func (gpointer self)
{
	gpointer result;
	result = ___lambda161_ (self);
...
plank_worker_add_task_with_result_co (PlankWorkerAddTaskWithResultData* _data_)
{
	...
	{
		_data_->tfunc = ____lambda161__gthread_func;
...
static void
_plank_worker____lambda162_ (PlankWorker* self,
                             PlankTask* task)
{
...
static void
__plank_worker____lambda162__gfunc (gpointer data,
                                    gpointer self)
{
	_plank_worker____lambda162_ ((PlankWorker*) self, (PlankTask*) data);
}
                          ...
                          GObjectConstructParam * construct_properties)
{
	...
	self = G_TYPE_CHECK_INSTANCE_CAST (obj, PLANK_TYPE_WORKER, PlankWorker);
	{
		...
		_tmp1_ = g_thread_pool_new (__plank_worker____lambda162__gfunc, self, thread_count, FALSE, &_inner_error0_);
		_tmp0_ = _tmp1_;
		if (G_UNLIKELY (_inner_error0_ != NULL)) {
			if (_inner_error0_->domain == G_THREAD_ERROR) {
				goto __catch0_g_thread_error;
