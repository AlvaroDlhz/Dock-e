...
static gboolean __lambda104_ (Block20Data* _data20_,
                       PlankUnityClient* client);
static gboolean ___lambda104__gee_forall_func (gpointer g,
                                        gpointer self);
static Block21Data* block21_data_ref (Block21Data* _data21_);
static void block21_data_unref (void * _userdata_);
static gboolean _____lambda102_ (Block21Data* _data21_);
static void plank_unity_perform_update (PlankUnity* self,
                                 const gchar* sender_name,
                                 GVariant* parameters);
static gboolean ______lambda102__gsource_func (gpointer self);
...
static gboolean __lambda103_ (Block22Data* _data22_,
                       PlankUnityClient* client);
static gboolean ___lambda103__gee_forall_func (gpointer g,
                                        gpointer self);
...
static gboolean
__lambda104_ (Block20Data* _data20_,
              PlankUnityClient* client)
{
	PlankUnity* self;
	const gchar* _tmp0_;
...
static gboolean
___lambda104__gee_forall_func (gpointer g,
                               gpointer self)
{
	gboolean result;
	result = __lambda104_ (self, (PlankUnityClient*) g);
	return result;
}
                                       ...
                                       PlankUnity* self)
{
	...
	gee_abstract_collection_foreach ((GeeAbstractCollection*) _tmp6_, ___lambda104__gee_forall_func, _data20_);
	_g_free0 (after);
	_g_free0 (before);
	block20_data_unref (_data20_);
	_data20_ = NULL;
...
static gboolean
_____lambda102_ (Block21Data* _data21_)
{
	PlankUnity* self;
...
static gboolean
______lambda102__gsource_func (gpointer self)
{
	gboolean result;
	result = _____lambda102_ (self);
	return result;
}
...
"s", sender_name);
				...
				_tmp11_->timer_id = g_timeout_add_full (G_PRIORITY_DEFAULT, PLANK_UNITY_UPDATE_THRESHOLD_DURATION, ______lambda102__gsource_func, block21_data_ref (_data21_), block21_data_unref);
			}
		} else {
...
static gboolean
__lambda103_ (Block22Data* _data22_,
              PlankUnityClient* client)
{
	PlankUnity* self;
	gboolean result;
...
static gboolean
___lambda103__gee_forall_func (gpointer g,
                               gpointer self)
{
	gboolean result;
	result = __lambda103_ (self, (PlankUnityClient*) g);
	return result;
}
...
"sv})'", _tmp3_, _data22_->sender_name);
	...
	gee_abstract_collection_foreach ((GeeAbstractCollection*) _tmp4_, ___lambda103__gee_forall_func, _data22_);
	block22_data_unref (_data22_);
	_data22_ = NULL;
}
