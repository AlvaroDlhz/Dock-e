/* plank.vapi generated by valac 0.56.16, do not modify. */
...
namespace Plank {
	...
	public class DockController : Plank.DockContainer {
		...
		public Plank.LauncherWindow launcher { get; protected set; }
	...
	public class DockTheme : Plank.Theme {
		...
		[Description (blurb = "The space between the dock and the screen edge, in tenths of a percent of IconSize.", nick = "dock-margin")]
	...
	public class HideManager : GLib.Object {
		...
		public bool ExternalMenuVisible { get; set; }
	...
	[CCode (cheader_filename = "plank.h")]
	public class LauncherItem : Plank.DockItem {
		public LauncherItem ();
	...
	[CCode (cheader_filename = "plank.h")]
	public class LauncherProvider : Plank.DockItemProvider {
		public LauncherProvider ();
		public override bool can_accept_drop (Gee.ArrayList<string> uris);
		public override bool move_to (Plank.DockElement move, Plank.DockElement target);
	}
	[CCode (cheader_filename = "plank.h")]
	...
	public class PositionManager : GLib.Object {
		...
		public Gdk.Rectangle get_screen_region_for_item (Plank.DockItem item);
	...
	[CCode (cheader_filename = "plank.h")]
	public class StatusIndicatorItem : Plank.DockItem {
		public StatusIndicatorItem (Plank.StatusIndicatorKind kind);
		public override bool can_be_removed ();
		protected override void draw_icon (Plank.Surface surface);
		public override Gee.ArrayList<Gtk.MenuItem> get_menu_items ();
		protected override Plank.AnimationType on_clicked (Plank.PopupButton button, Gdk.ModifierType mod, uint32 event_time);
		...
		protected override Plank.AnimationType on_scrolled (Gdk.ScrollDirection direction, Gdk.ModifierType mod, uint32 event_time);
		public Plank.StatusIndicatorKind Kind { get; construct; }
	}
	[CCode (cheader_filename = "plank.h")]
	public class StatusIndicatorProvider : Plank.DockItemProvider {
	...
	public class StatusPanelWindow : Gtk.Window {
		public StatusPanelWindow (Plank.DockController controller);
		public void dismiss ();
		public void toggle (Plank.StatusIndicatorItem item);
	}
	[CCode (cheader_filename = "plank.h")]
