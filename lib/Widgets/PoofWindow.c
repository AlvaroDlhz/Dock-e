...
static gboolean __lambda116_ (PlankPoofWindow* self);
 ...
 */
static gboolean
__lambda116_ (PlankPoofWindow* self)
{
	gboolean result;
...
{
	gboolean result;
	result = __lambda116_ ((PlankPoofWindow*) self);
	return result;
}
                           ...
                           gint y)
{
	...
	self->priv->animation_timer_id = gdk_threads_add_timeout ((guint) 30, ___lambda116__gsource_func, self);
}
