/* ClockDocklet.c generated by valac 0.56.16, the Vala compiler
...
VALA_EXTERN GType docky_clock_docklet_get_type (void) G_GNUC_CONST ;
...
VALA_EXTERN DockyClockDocklet* docky_clock_docklet_new (void);
VALA_EXTERN DockyClockDocklet* docky_clock_docklet_construct (GType object_type);
...
{
	static volatile gsize docky_clock_docklet_type_id__once = 0;
	if (g_once_init_enter (&docky_clock_docklet_type_id__once)) {
		GType docky_clock_docklet_type_id;
		docky_clock_docklet_type_id = docky_clock_docklet_get_type_once ();
		g_once_init_leave (&docky_clock_docklet_type_id__once, docky_clock_docklet_type_id);
	}
	return docky_clock_docklet_type_id__once;
}
